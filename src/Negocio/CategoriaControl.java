...
public class CategoriaControl {
    ...
    public DefaultTableModel listar(String texto){
        ...
        String titulos[] = {"Id","Nombre","Teléfono","Dirección","Nombre Empresa","Estatus"};
...
//            registro[5] = item.getImagenProveedor();
    ...
    public String insertar(String NombreProveedor, String TelefonoProveedor, String DireccionProveedor, String NombreEmpresaProveedor,boolean activo)
    {
